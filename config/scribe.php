...
return [
    ...
    'base_url' => env('API_DOCS_APP_URL', config('app.url') ),
    ...
    'auth' => [
        ...
        'enabled' => env('API_DOCS_AUTH', true),
        ...
        'extra_info' => 'You can set your token by login API at ' . env('API_DOCS_APP_URL') . '/api/v1/users/login',
    ],
